...
class ViewController: UIViewController {
    //PlayerA&B Cards
    @IBOutlet var playerACardsImageViews: [UIView]!
    @IBOutlet var playerBCardsImageViews: [UIView]!
    //PlayerA Suit&Rank
    ...
    override func viewDidLoad() {
        ...
        //卡牌UIView加入邊框＆邊框色＆底色
        for i in 0...4 {
            playerACardsImageViews[i].layer.borderWidth = 0.5
            playerACardsImageViews[i].layer.borderColor = UIColor.black.cgColor
            playerACardsImageViews[i].backgroundColor = UIColor.white
            playerBCardsImageViews[i].layer.borderWidth = 0.5
            playerBCardsImageViews[i].layer.borderColor = UIColor.black.cgColor
            playerBCardsImageViews[i].backgroundColor = UIColor.white
        }
    }
    ...
    func  gameInit() {
       ...
       //使卡牌imageView顯示兩張，並抽兩張牌
        for i in 0...4 {
            if i < 2 {
                playerACardsImageViews[i].isHidden = false
                playerBCardsImageViews[i].isHidden = false
                cards.shuffle()
                ...
                playerACardsImageViews[i].isHidden = true
                playerBCardsImageViews[i].isHidden = true
            }
        }
        //算兩張卡牌點數總和
        for i in 0...1 {
    ...
    @IBAction func getACard(_ sender: UIButton) {
        ...
        index = index + 1
        //每點選一次，抽一張牌
        playerBCardsImageViews[index].isHidden = false
